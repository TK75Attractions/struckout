...
fun BleInfoView(
    ...
    val x = rememberTextFieldState(cameraLocation?.x.toString())
    val y = rememberTextFieldState(cameraLocation?.y.toString())
    val z = rememberTextFieldState(cameraLocation?.z.toString())
